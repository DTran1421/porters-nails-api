...
module.exports = async function handler(req, res) {
  res.setHeader('Access-Control-Allow-Origin', 'https://portersnailsspa.com');
  ...
  try {
    ...
    await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: "Porter's Nails <bookings@portersnailsspa.com>",
        to: [OWNER_EMAIL],
        ...
        html: `<div style="font-family:sans-serif;max-width:540px;margin:0 auto;padding:24px">
          ...
          <a href="https://portersnailsspa.com/manage/manage.html"
