// Porter's Nails — approve or decline an appointment
// Updates Supabase and emails the customer if they provided an address.
...
module.exports = async function handler(req, res) {
  ...
  const { id, status, name, email, service, date, time } = req.body;
